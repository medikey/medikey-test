// Bitcoin-style icons for MediKey healthcare application
// Inspired by https://bitcoinicons.com/
...
export const SecureIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MediKeyLogo: React.FC<IconProps> = ({ className = "", size = 32 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 32 32"
  ...
  >
    <defs>
      <linearGradient id="medikey-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    {/* Shield base */}
    <path
      d="M16 2L6 6v8c0 6.5 4.5 12.5 10 14 5.5-1.5 10-7.5 10-14V6l-10-4z"
      fill="url(#medikey-gradient)"
      stroke="none"
    />
    ...
    <path d="M18 12h-2v2" stroke="white" strokeWidth="1.5" fill="none" />
  </svg>
);